...
f.write("\nip_orders: /orders_export.csv")
f.write("\nip_customers: /customers_export.csv")
f.write("\nip_products: /products_export.csv")
f.write("\nip_gross_profit_prod: /vend-gross_profit-for-product_variant-by-month.csv")
f.write("\nip_gross_profit_type: /vend-gross_profit-for-type-by-month.csv")
f.write("\nip_total_revenue_prod: /vend-total_revenue-for-product_variant-by-month.csv")
f.write("\nip_total_revenue_type: /vend-total_revenue-for-type-by-month.csv")
f.write("\nip_total_revenue_daily: /vend-total_revenue-sales_summary-by-day.csv")

# output files
f.write("\nop_all_bought_together: /all_bought_together.csv")
f.write("\nop_monthly_bought_together: /monthly_bought_together.csv")
f.write("\nop_cust_retention: /cust_retention.csv")
f.write("\nop_customer_dates: /customer_dates.csv")
...
f.write("\nop_customers: /customers.csv")
f.write("\nop_order_frequency: /order_frequency.csv")
f.write("\nop_products: /products.csv")
f.write("\nop_products_dates: /products_dates.csv")
f.write("\nop_revenue_by_type: /revenue_by_type.csv")
f.write("\nop_week_unfulfilled_orders: /week_unfulfilled_orders.csv")
f.write("\nop_yr_unfulfilled_orders: /yr_unfulfilled_orders.csv")
f.write("\nop_year_to_date_by_day: /year_to_date_by_day.csv")
f.write("\nop_cust_score: /cust_score.csv")
